...
<img align='middle' src='kokopelli-circle-swing-dependency.svg'/>
...
### Synchronization: External Source of Circle and Phase (CLK + PHASE)

This mode is works almost the same as the previous one. Instead of analyzing abrupt phase changes (when saw ends at its corner and goes down) it uses external circle pulse to determine the beat moment.
...
<img align='right' src='circle-blueprint.svg' class='md-only'/>
